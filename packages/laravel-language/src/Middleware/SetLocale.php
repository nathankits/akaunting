...
class SetLocale
{
    ...
    {
        // Carbon 3 and Laravel 13 type setLocale() as string, so reject any
        // non-string value (e.g. reset() on an empty language list) up front.
    ...
    public function setDefaultLocale()
    {
        if (config('language.auto')) {
            ...
            $this->setLocale(reset($languages) ?: config('app.locale'));
        } else {
